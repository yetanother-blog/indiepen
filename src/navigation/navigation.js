import { previewHtml, previewCss, previewJs, result, PREVIEW_HTML_CLASS, PREVIEW_CSS_CLASS, PREVIEW_JS_CLASS, RESULT_CLASS } from '../constants';
...
function handleAriaPressedState(currentButton) {
    ...
    const isPressed = Boolean(currentButton.getAttribute('aria-pressed') === 'true');
